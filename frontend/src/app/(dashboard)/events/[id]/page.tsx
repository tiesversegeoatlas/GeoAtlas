            ...
            <CardContent className="p-4 space-y-4">
              ...
              <div className="flex items-center gap-3 p-3 rounded-lg bg-white/5 border border-white/5">
                ...
                <div className="text-xs">
                  <div className="font-bold text-white uppercase">Primary OSINT Verified</div>
                  <div className="text-muted-foreground">Cross-referenced with multiple independent satellite and field reports.</div>
                </div>
              </div>
            </CardContent>
          </Card>
